...
function initSlickCarousel() {
	jQuery('.collection-nft-slider').slick({
		slidesToScroll: 1,
		slidesToShow: 4,
		rows: 0,
		prevArrow: '<a href="#" class="slick-prev"><i class="icon-left"></i></a>',
		nextArrow: '<a href="#" class="slick-next"><i class="icon-right"></i></a>',
		responsive: [{
			breakpoint: 1024,
			settings: {
				slidesToScroll: 1,
